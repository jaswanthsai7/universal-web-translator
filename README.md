# 📺 BiliBili English Translator (Manifest V3)

> **Fast, Native In-Place Translation Extension for Bilibili and Modern SPAs (React & Vue 3)**

**BiliBili English Translator** is a modern, high-performance browser extension that translates Bilibili directly in place without breaking page layout, video playback, Vue/React reactivity, or user interactions.
...
* **Zero Floating Coordinate Drift**: Unlike older overlay-based translators where translated text floats in detached boxes and drifts into the air during scrolling, BiliBili English Translator modifies text directly inside existing DOM Text Nodes.
...
Your privacy is a fundamental core principle of **BiliBili English Translator**.
...
5. Pin **BiliBili English Translator** to your toolbar and visit [bilibili.com](https://www.bilibili.com)!
